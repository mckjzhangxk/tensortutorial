...
})({"lv0n2":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "b63ea9d2dac02529";
"use strict";
...
},{}],"78VEz":[function(require,module,exports) {
var _fashionDataJs = require("./fashion-data.js");
...
async function train(model, data) {
    ...
    const [trainXs, trainYs] = tf.tidy(()=>{
        let d = data.nextTestBatch(TRAIN_DATA_SIZE);
        let xs = tf.reshape(d.xs, [
            TRAIN_DATA_SIZE,
            28,
            28,
            1
    ...
    const [testXs, testYs] = tf.tidy(()=>{
        let d = data.nextTestBatch(TEST_DATA_SIZE);
        let xs = tf.reshape(d.xs, [
            TEST_DATA_SIZE,
            28,
            28,
...
function save() {
    ...
    var resized = tf.image.resizeBilinear(raw, [
        28,
        28
    ]);
...
async function run() {
    const data = new _fashionDataJs.FMnistData();
    await data.load();
...
},{"./fashion-data.js":"bjAlz"}]},["lv0n2","78VEz"], "78VEz", "parcelRequired347")

//# sourceMappingURL=hw2.dac02529.js.map
